"""
Flask route handlers for monitoring and throughput
Handles throughput data, history, exports, health checks, services status, and database management
"""
...
from logger import debug, info, error, exception, warning
from version import get_version_info


def register_monitoring_routes(app, csrf, limiter):
    """Register monitoring and throughput-related routes"""
    debug("Registering monitoring routes")
    ...
    debug("Monitoring routes registered successfully")
